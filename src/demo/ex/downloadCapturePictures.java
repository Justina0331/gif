...
public class downloadCapturePictures {
	private static String DirMove = "C:\\capturePictures"; //目標資料夾
	private static String source; //來源照片路徑
	private static String srcPicturesName;
	
	public downloadCapturePictures(File srcPictures) throws java.io.IOException {
		// 來源
